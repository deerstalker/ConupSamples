...
public class LaunchStationAuth {
	...
	public static void main(String[] args){
		ComponentLaunch dbComponentLaunch = new ComponentLaunch(
				"/home/deerstalker/conup/conup-read-only/samples/hydrology-station-status-auth-update/target/classes",
				"hydrology-station-status-auth-update", "App.composite", "HydrologyStationAuthComponent");
		try {
