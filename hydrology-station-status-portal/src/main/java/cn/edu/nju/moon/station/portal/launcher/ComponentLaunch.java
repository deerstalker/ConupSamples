...
import cn.edu.nju.moon.station.portal.services.Portal;
import cn.edu.nju.moon.station.portal.services.Proc;
...
//		try {
//			Portal portal = node.getService(Portal.class, "HydrologyStationPortalComponent");
//			System.out.println(portal.execute("62914200"));
